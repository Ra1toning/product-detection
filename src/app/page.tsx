    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-4 bg-gray-900">
      <div className="w-full max-w-fit flex flex-col items-start p-4 bg-gray-200 dark:bg-zinc-800 rounded-lg shadow-lg mb-4">
        ...
        <div className="content relative">
          <video autoPlay playsInline muted ref={videoRef} className="relative w-full h-[100vh] rounded-md object-cover max-w-fit max-h-fit" id="frame" />
          <canvas className="absolute top-0 left-0 w-screen h-[100vh] z-99999 max-w-full max-h-fit" ref={canvasRef}></canvas>
        </div>
      </div>
    </main>
  );
